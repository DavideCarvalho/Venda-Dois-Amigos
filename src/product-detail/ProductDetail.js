        ...
        <div className="container">
          <div className="columns is-multiline">
            ...
            <div className="column">
              ...
              <p>Nome: {this.state.product.name}</p>
              <p>Valor: {this.state.product.value}</p>
              <p>Descrição: {this.state.product.description}</p>
              <p>Cores: {this.state.product.colors}</p>
              <p>Frete: {this.state.product.freight}</p>
            </div>
          </div>
          <button onClick={() => this.buyProduct(this.state.product)}>Comprar</button>
        </div>
      </div>
    )
  }
